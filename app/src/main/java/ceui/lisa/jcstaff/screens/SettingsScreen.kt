    ...
    Scaffold(
        ...
        Column(
            ...
            Row(
                modifier = Modifier
                    .fillMaxWidth()
                    .clickable { navViewModel.navigate(NavRoute.AccountManagement) }
                    .padding(horizontal = 16.dp, vertical = 12.dp),
                verticalAlignment = Alignment.CenterVertically
            ) {
                Column(modifier = Modifier.weight(1f)) {
                    ...
                    Text(
                        text = stringResource(R.string.account_management_desc),
                        style = MaterialTheme.typography.bodyMedium,
                        color = MaterialTheme.colorScheme.onSurfaceVariant
                    )
                }
            ...
            Row(
                modifier = Modifier
                    .fillMaxWidth()
                    .clickable { navViewModel.navigate(NavRoute.CacheBrowser()) }
                    .padding(horizontal = 16.dp, vertical = 12.dp),
                verticalAlignment = Alignment.CenterVertically
            ) {
                Column(modifier = Modifier.weight(1f)) {
                    Text(
                        text = stringResource(R.string.cache_browser),
                        style = MaterialTheme.typography.bodyLarge
                    )
                    Text(
                        text = stringResource(R.string.cache_browser_desc),
                        style = MaterialTheme.typography.bodyMedium,
                        color = MaterialTheme.colorScheme.onSurfaceVariant
                    )
                }
            ...
            Button(
                ...
                modifier = Modifier
                    ...
                    .padding(bottom = 16.dp + navBarBottom)
                    .height(56.dp),
